...
CMD ["/bin/bash"]
RUN wget -q http://repo.continuum.io/archive/Anaconda2-4.0.0-Linux-x86_64.sh
RUN bash Anaconda2-4.0.0-Linux-x86_64.sh
RUN wget -q https://github.com/blaze/blaze/archive/master.zip
FROM php:5.6-fpm
